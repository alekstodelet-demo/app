...
import S_DocumentTemplateAddEditBaseView from './base';
...
const S_DocumentTemplatePopupForm: FC<PopupFormProps> = observer((props) => {
  ...
  return (
    <Dialog open={props.openPanel} onClose={props.onBtnCancelClick} maxWidth="sm" fullWidth>
      <DialogTitle>{translate('label:S_DocumentTemplateAddEditView.entityTitle')}</DialogTitle>
      <DialogContent>
...
export default S_DocumentTemplatePopupForm
