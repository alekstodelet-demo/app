...
import { deleteS_DocumentTemplate } from "api/S_DocumentTemplate";
...
class NewStore {
  ...
  deleteS_DocumentTemplate(id: number){
    MainStore.openErrorConfirm(
      ...
      async () => {
        try {
          MainStore.changeLoader(true);
          const response = await deleteS_DocumentTemplate(id);
