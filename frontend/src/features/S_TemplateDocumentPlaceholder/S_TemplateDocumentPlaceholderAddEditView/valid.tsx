...
export const schema = yup.object().shape({
  ...
  idTemplateDocument: yup.number().notOneOf([0], "Required field").required("Required field"),
  idPlaceholder: yup.number().notOneOf([0], "Required field").required("Required field"),
});
