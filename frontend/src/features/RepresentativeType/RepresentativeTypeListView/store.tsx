...
import { deleteRepresentativeType } from "api/RepresentativeType";
import { RepresentativeType } from "constants/RepresentativeType";
import { getRepresentativeTypes } from "api/RepresentativeType";

class RepresentativeTypeListStore extends BaseStore {
  @observable data: RepresentativeType[] = [];
  ...
  deleteRepresentativeType = (id: number) => {
...
export default new RepresentativeTypeListStore();
