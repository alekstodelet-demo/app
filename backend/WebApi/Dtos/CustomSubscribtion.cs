...
{
    public class CustomSubscribtion
    {

        public class CreateCustomSubscribtionRequest
        {
            ...
            public SubscribtionContactType SubscribtionContactType { get; set;}

        }
    }

        public class UpdateCustomSubscribtionRequest
        {
        public int? idSubscriberType { get; set; }
        public int idSchedule { get; set; }
        public int? idRepeatType { get; set; }
